				...
				if( $field_value_arr )
				{
					foreach( $field_value_arr AS $key => $row )
					{
						...
						$field_html .= '<div>
							...
							<input type="text" name="tv'. $field_id .'prval2[]"  value="'. $rowa[ 2 ] .'" '. $field_style .' /> &nbsp;
							<input type="text" name="tv'. $field_id .'prval3[]"  value="'. $rowa[ 3 ] .'" '. $field_style .' /> &nbsp;
							<input type="button" value="-" onclick="scornRemoveParams'. $field_id .'( this )" />
						</div>';
					}
				}
				
				$field_html .= '<input type="button" value="+" onclick="scornAddParams'. $field_id .'( this )" data-cc="'. ( count( $field_value_arr ) - 1 ) .'" /><div style="height:30px;">&nbsp;</div>';
				...
				$field_html .= "
					...
					<script type=\"text/javascript\">
						/* <![CDATA[ */
							...
							function scornAddParams". $field_id ."( ctrl )
							{
								var cc= \$v( ctrl ).data( 'cc' ) + 1;
								\$v( ctrl ).data( 'cc', cc );
								\$v( '<div><input type=\"text\" name=\"tv". $field_id ."prnm[]\" ". $field_style ."> &nbsp; <input type=\"text\" name=\"tv". $field_id ."prval[]\" ". $field_style ."> &nbsp; <input type=\"text\" name=\"tv". $field_id ."prval2[]\" ". $field_style ."> &nbsp;<input type=\"text\" name=\"tv". $field_id ."prval3[]\" ". $field_style ."> &nbsp;<input type=\"button\" value=\"-\" onclick=\"scornRemoveParams". $field_id ."( this )\" /></div>').insertBefore( ctrl );
							}
						/* ]]> */
					</script>";
				break;
			...
			//v003
				...
				if( $field_value_arr )
				{
					foreach( $field_value_arr AS $key => $row )
					{
						$rowa= explode( "::", $row );
						$field_html .= '<div>
							<input style="width:15%" type="text" name="tv'. $field_id .'prnm[]"  value="'. $rowa[ 0 ] .'" '. $field_style .' /> &nbsp;
							<input style="width:15%" type="text" name="tv'. $field_id .'prval[]"  value="'. $rowa[ 1 ] .'" '. $field_style .' /> &nbsp;
							<input style="width:15%" type="text" name="tv'. $field_id .'prval2[]"  value="'. $rowa[ 2 ] .'" '. $field_style .' /> &nbsp;
							<input style="width:15%" type="text" name="tv'. $field_id .'prval3[]"  value="'. $rowa[ 3 ] .'" '. $field_style .' /> &nbsp;
							<input style="width:15%" type="text" name="tv'. $field_id .'prval4[]"  value="'. $rowa[ 4 ] .'" '. $field_style .' /> &nbsp;
							<input type="button" value="-" onclick="scornRemoveParams'. $field_id .'( this )" />
						</div>';
					}
				}
					...
					<script type=\"text/javascript\">
						/* <![CDATA[ */
							...
							function scornAddParams". $field_id ."( ctrl )
							{
								var cc= \$v( ctrl ).data( 'cc' ) + 1;
								\$v( ctrl ).data( 'cc', cc );
								\$v( '<div><input style=\"width:15%\" type=\"text\" name=\"tv". $field_id ."prnm[]\" ". $field_style ."> &nbsp; <input style=\"width:15%\"  type=\"text\" name=\"tv". $field_id ."prval[]\" ". $field_style ."> &nbsp; <input  style=\"width:15%\" type=\"text\" name=\"tv". $field_id ."prval2[]\" ". $field_style ."> &nbsp;<input style=\"width:15%\"  type=\"text\" name=\"tv". $field_id ."prval3[]\" ". $field_style ."> &nbsp;<input style=\"width:15%\"  type=\"text\" name=\"tv". $field_id ."prval4[]\" ". $field_style ."> &nbsp;<input type=\"button\" value=\"-\" onclick=\"scornRemoveParams". $field_id ."( this )\" /></div>').insertBefore( ctrl );
							}
						/* ]]> */
					</script>";
				break;
			...
			//v003
				...
				if( $field_value_arr )
				{
					...
					<script type=\"text/javascript\">
						...
						$field_html .= '<div><input type="text" id="tv'. $field_id .'_'. $key .'" name="tv'. $field_id .'climg[]"  value="'. $rowa[0] .'" '. $field_style .' onchange="documentDirty=true;" />&nbsp;
						...
						<input type="button" value="'. $_lang['insert'] .'" onclick="BrowseServer( \'tv'. $field_id .'_'. $key .'\' )" />&nbsp;&nbsp;<input type="button" value="-" onclick="scornImageRemove'. $field_id .'( this )" /><div><img style="max-width:300px;max-height:70px;" src="http://'. $_SERVER[ 'SERVER_NAME' ] .'/'. $rowa[0] .'" /></div></div><br />';
					}
				}
				...
				if( $field_value_arr )
				{
					...
					{
						$rowa= explode( "::", $row );
						$field_html .= '<div><input type="text" id="tv'. $field_id .'_'. $key .'" name="tv'. $field_id .'climg[]"  value="'. $rowa[0] .'" '. $field_style .' onchange="documentDirty=true;" />&nbsp;<input type="button" value="'. $_lang['insert'] .'" onclick="BrowseServer( \'tv'. $field_id .'_'. $key .'\' )" />&nbsp; - Наименование&nbsp;<input style="width:70px;" type="text" name="tv'. $field_id .'clart[]" value="'. $rowa[1] .'" />&nbsp;&nbsp; Описание&nbsp;<input style="width:150px;" type="text" name="tv'. $field_id .'clnm[]" value="'. $rowa[2] .'" /> &nbsp;<input type="button" value="-" onclick="scornColorRemove( this )" /></div><div><img style="max-width:300px;max-height:100px;" src="http://'. $_SERVER[ 'SERVER_NAME' ] .'/'. $rowa[0] .'" /></div>';
					}
				}
				
				$field_html .= '<input type="button" value="+" onclick="scornColorsAdd( this )" data-cc="'. ( count( $field_value_arr ) - 1 ) .'" />';
				...
				$field_html .= "
					...
					<script type=\"text/javascript\">
						/* <![CDATA[ */
							...
							function scornColorRemove( ctrl )
							{
								\$v( ctrl ).parent().remove();
							}
							
							function scornColorsAdd( ctrl )
							{
								var cc= \$v( ctrl ).data( 'cc' ) + 1;
								\$v( ctrl ).data( 'cc', cc );
								\$v( '<div><input type=\"text\" id=\"tv". $field_id ."_'+ cc +'\" name=\"tv". $field_id ."climg[]\" ". $field_style ." onchange=\"documentDirty=true;\">&nbsp;<input type=\"button\" value=\"". $_lang['insert'] ."\" onclick=\"BrowseServer( \\'tv". $field_id ."_'+ cc +'\\' )\" />&nbsp; - Арт.&nbsp;<input style=\"width:70px;\" type=\"text\" name=\"tv". $field_id ."clart[]\" value=\"\" />&nbsp;&nbsp; Название&nbsp;<input style=\"width:150px;\" type=\"text\" name=\"tv". $field_id ."clnm[]\" value=\"\" /> &nbsp;<input type=\"button\" value=\"-\" onclick=\"scornColorRemove( this )\" /></div>' ).insertBefore( ctrl );
							}
