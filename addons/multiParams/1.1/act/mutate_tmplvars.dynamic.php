  ...
  <tr>
    ...
    <td><select name="type" size="1" class="inputBox" style="width:300px;" onchange="documentDirty=true;">
                ...
                <optgroup label="Delta">
                    <option value="params-multiple_x4" <?php     echo ($content['type']=='params-multiple_x4')? "selected='selected'":""; ?>>Parameters (Multiple x 4)</option><!--scorn-->
                    <option value="params-multiple_x2" <?php     echo ($content['type']=='params-multiple_x2')? "selected='selected'":""; ?>>Parameters (Multiple x 2)</option><!--scorn-->
                    <option value="params-multiple_x5" <?php     echo ($content['type']=='params-multiple_x5')? "selected='selected'":""; ?>>Parameters (Multiple x 5)</option><!--scorn-->
                    <option value="images-multiple" <?php     echo ($content['type']=='images-multiple')? "selected='selected'":""; ?>>Images (Multiple)</option><!--scorn-->
                    <option value="colors-multiple" <?php     echo ($content['type']=='colors-multiple')? "selected='selected'":""; ?>>Colors (Multiple)</option><!--scorn-->
                </optgroup>
